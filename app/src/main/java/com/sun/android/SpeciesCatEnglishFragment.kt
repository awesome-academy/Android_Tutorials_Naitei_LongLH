...
import com.sun.android.databinding.FragmentSpeciesCatEnglishBinding
import com.sun.android.constants.*

class SpeciesCatEnglishFragment : Fragment() {

    private val binding: FragmentSpeciesCatEnglishBinding by lazy {
        FragmentSpeciesCatEnglishBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreateView(
        ...
        binding.btnViewDetailCat1.setOnClickListener {
            ...
            intent.putExtra(LANGUAGE_KEY, ENGLISH_LANGUAGE)
    ...
    companion object {
        @JvmStatic
        fun newInstance() = SpeciesCatEnglishFragment()
    }
}
